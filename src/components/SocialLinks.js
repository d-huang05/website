...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
        <path d="M17.5 8.5c0-4.694-3.806-8.5-8.5-8.5S.5 3.806.5 8.5 4.306 17 9 17c1.657 0 3.19-.477 4.5-1.296V19.5c0 .276.224.5.5.5s.5-.224.5-.5v-4.796c1.31.819 2.843 1.296 4.5 1.296 4.694 0 8.5-3.806 8.5-8.5zM9 16c-4.142 0-7.5-3.358-7.5-7.5S4.858 1 9 1s7.5 3.358 7.5 7.5S13.142 16 9 16z" />
      </svg>
    ),
  },
  {
